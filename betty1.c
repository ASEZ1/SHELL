...
/**
 * copy_string_strcpy - Copies a string from the source to the destination buffer
 * @dest: destination buffer pointer
 * @src: source string pointer
 * 
 * Return: Pointer to the beginning of the destination buffer, indicating the copied string.
 */
char *copy_string_strcpy(char *dest, const char *src)
{
	char *p = dest;
...
/**
 * concat_string_strcat - appends (concatenates) the source string src to the destination string dest.
 * @dest: pointer to the destination string
 * @src: pointer to the source string
 * 
 * Return: returns a pointer to the beginning of the modified destination string dest
 */
char *concat_string_strcat(char *dest, const char *src)
{
...
/**
 * _environ_get - etrieves the value of an environment variable.
...
/**
 * cmd_get - searches for a specified command within the directories listed in the PATH environment variable
 * @command: pointer to the command to be searched for
 * 
 * Return: returns a pointer to a string representing the full path of the specified command
 */
char *cmd_get(char *command)
{
...
/**
 * str_split - splits a string into an array of tokens based on a specified delimiter
 * @buffer: pointer to the string to be split
 * @del: pointer to the delimiter string used for splitting
 * Return: returns a pointer to a dynamically allocated array of pointers, where each element points to a token obtained from the buffer
 */
char **str_split(char *buffer, const char *del)
{
	char **tokens = NULL;
...
/**
 * cmd_exec - attempts to execute a command specified by args[0] with the provided arguments and environment variables.
 * @args: pointer to an array of strings representing the command and its arguments
 * @env: pointer to an array of strings representing the environment variables
 * Return: The function does not return any value as it has a void return type
 */
void cmd_exec(char **args, char **env)
{
...
/**
 * Simple shell program that takes user input, processes commands, and executes them as separate processes.
 * @param ac: The number of command-line arguments (unused).
 * @param av: An array of command-line argument strings (unused).
